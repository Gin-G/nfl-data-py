    ...
    if 2025 in seasons:
        ...
        if not API_KEY:
            ...
            if not df_2025.empty:
                ...
                rosters_2025 = import_weekly_rosters([2025])
                
                # Create mapping: sportradar_id -> player_id (gsis_id) + metadata
                id_mapping = rosters_2025[[
                    'sportradar_id', 'player_id', 'headshot_url', 'position'
                ]].drop_duplicates('sportradar_id')
                ...
                print("  No 2025 data collected")

    # Combine historical and current data
    if historical_seasons:
        historical_data = import_weekly_data(historical_seasons)
